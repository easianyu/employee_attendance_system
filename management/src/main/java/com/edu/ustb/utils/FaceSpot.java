...
public class FaceSpot {
    ...
    //需要修改为自己的
    private static final String AppID = "20279998";
    private static final String APIKey = "sMUwPHkVed2mFFQbL2MvMyGU";
    private static final String SecretKey = "DCZuOPwBj78fGK1Ouws3bMLt3DeIjSGF";
...
//        String file1 = "/Users/jesse/Desktop/me1.jpg";
        String file1 = "/Users/jesse/Desktop/yyx.jpg";
        byte[] img2 = FileToByte(new File(file1));
        System.out.println(addUser(img2, "BASE64", "2002", "face"));
        System.out.println("-----------------------");
//        System.out.println(searchFace(img2,"face", "2002"));
    }
    ...
    //判断是否通过图像检测
    public static boolean isPass (String imgStr, String groupIdList,
                                 String userId) throws Exception{
        JSONObject js = FaceSpot.searchFace(imgStr, groupIdList, userId);
        String s1 = js.toString(2);
        System.out.println(s1);
        int i = s1.indexOf("\"score\":");
        String ss2 = s1.substring(i + 9, i + 20);
        double v = Double.parseDouble(ss2);
